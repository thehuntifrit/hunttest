...
const RANK_COLORS = {
    S: { bg: 'bg-amber-600', hover: 'hover:bg-amber-700', text: 'text-amber-600', rgbaBorder: 'rgba(217, 119, 6, 0.4)', label: 'S' },
    A: { bg: 'bg-green-600', hover: 'hover:bg-green-700', text: 'text-green-600', rgbaBorder: 'rgba(22, 163, 74, 0.4)', label: 'A' },
    F: { bg: 'bg-purple-600', hover: 'hover:bg-purple-700', text: 'text-purple-600', rgbaBorder: 'rgba(147, 51, 234, 0.4)', label: 'F' },
};
