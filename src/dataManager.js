...
const RANK_COLORS = {
    S: { bg: 'bg-amber-600', hover: 'hover:bg-amber-700', text: 'text-amber-600', hex: '#ff8c00', border: "border-amber-300", label: 'S' },
    A: { bg: 'bg-green-600', hover: 'hover:bg-green-700', text: 'text-green-600', hex: '#0000cd', border: "border-green-300", label: 'A' },
    F: { bg: 'bg-purple-600', hover: 'hover:bg-purple-700', text: 'text-purple-600', hex: '#006400', border: "border-purple-300", label: 'F' },
};
