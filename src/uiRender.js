...
function updateAreaInfo(card, mob) {
  ...
  let areaInfoHtml = `<span class="flex items-center gap-1 font-normal"><span>${mob.Area}</span><span class="opacity-50">|</span><span class="flex items-center">${mob.Expansion}<span class="border border-white text-white px-[3px] rounded text-[10px] ml-[1px] leading-tight relative -top-[1px]">${mob.Rank}</span></span>`;
