...
<div class="expandable-panel bg-gray-800/70 ${isOpen ? 'open' : ''}">
    <div class="px-2 py-0 text-sm space-y-0.5">
        <div class="flex justify-between items-start flex-wrap">
            ...
            <div class="mob-memo-row text-sm text-gray-300"><span class="mr-1">Memo:</span><span data-last-memo data-mob-no="..."></span></div>
...
  const { elapsedPercent, nextMinRepopDate, nextConditionSpawnDate, minRepop, maxRepop, status, isInConditionWindow, remainingSec, timeRemaining
        } = mob.repopInfo || {};
